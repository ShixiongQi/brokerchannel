...
func Get(ctx context.Context) v1alpha1.BrokerChannelInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/sample-source/pkg/client/informers/externalversions/samples/v1alpha1.BrokerChannelInformer from context.")
	}
