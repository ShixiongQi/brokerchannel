...
import (
	...
	brokerchannel "knative.dev/sample-source/pkg/client/injection/informers/samples/v1alpha1/brokerchannel"
)

const (
	defaultControllerAgentName = "brokerchannel-controller"
	defaultFinalizerName       = "brokerchannels.samples.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	brokerchannelInformer := brokerchannel.Get(ctx)

	lister := brokerchannelInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "samples.knative.dev.BrokerChannel"),
	)
