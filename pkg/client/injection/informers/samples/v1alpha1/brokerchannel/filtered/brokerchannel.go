...
func Get(ctx context.Context, selector string) v1alpha1.BrokerChannelInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch knative.dev/sample-source/pkg/client/informers/externalversions/samples/v1alpha1.BrokerChannelInformer with selector %s from context.", selector)
	}
