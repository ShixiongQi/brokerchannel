...
import (
	...
	lister "github.com/cowbon/brokerchannel/pkg/client/lister/apis/sample/v1alpha1"
	v1alpha1 "github.com/cowbon/brokerchannel/pkg/apis/sample/v1alpha1"
	"go.uber.org/zap"
...
func (r *Reconciler) ReconcileKind(ctx context.Context, bc v1alpha1.BrokerChannel) pkgreconciler.Event {
	...
	for idx, s := range bc.Spec.Subscribers {
		...
		ret := &messagingv1.Subscription {
			...
			Spec: messagingv1.SubscriptionSpec{
				...
				Subscriber: &pkgduckv1.Destination{
					Ref: bc.Spec.Subscriber[idx].Destination.Ref,
				},
			},
		}
